...
interface InfopilotHeroSectionProps {
  className?: string;
}
...
export function InfopilotHeroSection({ className }: InfopilotHeroSectionProps) {
  return (
    <section id="infopilot" className={cn("space-y-6", className)}>
      {/* Dark hero block */}
