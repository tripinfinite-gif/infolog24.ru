...
export const companyInfo: CompanyInfo = {
  ...
  foundedYear: 2016,
  description:
    "Помогаем оформить пропуск в Москву для грузового транспорта с 2016 года. Более 50 000 пропусков, 98% одобрение, регламентный срок — 10 рабочих дней. Берём на себя весь процесс — от подготовки документов до подачи в Дептранс и подключения к РНИС. Вы передаёте документы — мы ведём дело до результата.",
  mission:
    "Избавить перевозчиков от бюрократии, штрафов и простоев. Пока вы зарабатываете — мы занимаемся документами.",
  values: [
    {
      title: "Скорость",
      description:
        "Регламентный срок Дептранса — 10 рабочих дней. Временный пропуск — за 1 день. На время оформления годового временный предоставляем бесплатно — ваш груз уже в Москве.",
      icon: "Zap",
    },
    {
      title: "Надёжность",
  ...
  advantages: [
    ...
    {
      title: "Более 50 000 пропусков за 10 лет",
      description:
    ...
    {
      title: "Прозрачно и по закону",
      description:
        "Юрлицо с 2016 года. Договор и чеки с каждым клиентом. Не как «брокеры», которые отменяют пропуск через 3 дня. Проверьте нас на 2ГИС и Яндексе.",
      icon: "Lock",
    },
  ],
  team: {
  ...
  contacts: {
    ...
    // Юридический адрес из ЕГРЮЛ (актуальный на 2026-04-20 — Крутицкий пер.).
    legalAddress:
      "109044, г. Москва, муниципальный округ Южнопортовый, 2-й Крутицкий пер., д. 18, стр. 1, помещ. 2/1",
    // Фактический адрес совпадает с юридическим (старый адрес на Подольском
    // шоссе более не используется — актуализировано 2026-04-20).
    physicalAddress:
      "109044, г. Москва, муниципальный округ Южнопортовый, 2-й Крутицкий пер., д. 18, стр. 1, помещ. 2/1",
    workingHours: "Пн–Пт: 9:00–20:00",
    // Координаты 2-го Крутицкого переулка, д. 18 (МО Южнопортовый).
    coordinates: {
      lat: 55.7314,
      lng: 37.6632,
    },
