...
export const metadata: Metadata = {
  title: "Стоимость оформления пропусков — Инфолог24",
  description:
  ...
  twitter: {
    ...
    title: "Стоимость оформления пропусков — Инфолог24",
    description:
      "Пропуск от 12 000 ₽ за год vs штраф 215 000 ₽ за один рейс.",
  },
  alternates: {
    canonical: "https://inlog24.ru/pricing",
  },
};
