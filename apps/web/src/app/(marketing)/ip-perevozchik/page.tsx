...
export const metadata: Metadata = {
  ...
  description:
    "Оформление пропуска на МКАД, ТТК и Садовое кольцо для ИП и частных перевозчиков за 3 дня. Фиксированная цена от 12 000 ₽, гарантия возврата денег, помощь с документами.",
  keywords: [
...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "Стандартный срок — 3 рабочих дня с момента подачи полного пакета документов. В срочных случаях возможно ускоренное оформление — уточняйте у менеджера.",
  },
  {
  ...
  return (
    <>
      ...
      <ServiceJsonLd
        ...
        description="Оформление пропуска на МКАД, ТТК и Садовое кольцо для ИП. Фиксированная цена от 12 000 ₽, гарантия возврата денег."
        price={12000}
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mt-8 grid grid-cols-2 gap-4 text-center md:grid-cols-4">
            {[
              ...
              { value: "3 дня", label: "срок оформления" },
