...
export const metadata: Metadata = {
  title: "Антиштраф — мониторинг пропусков парка | Инфологистик-24",
  description:
  ...
  openGraph: {
    title: "Антиштраф — мониторинг парка от Инфологистик-24",
    description:
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <ul className="mt-10 space-y-4">
            {[
              ...
              "Пуш-уведомления в корпоративном ЛК Инфологистик-24",
