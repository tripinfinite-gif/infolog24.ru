...
export const metadata: Metadata = {
  title: "ГосЛог для перевозчиков — подготовка к 1 марта 2027",
  description:
          ...
          <div className="grid grid-cols-1 gap-10 lg:grid-cols-[1.15fr_1fr] lg:items-center">
            <div>
              ...
              <p className="mt-6 max-w-xl text-lg leading-relaxed text-primary-foreground/85">
                Не подаём за вас — сопровождаем. База знаний, пошаговый гайд, чек-лист готовности и прямая консультация юриста. Официальную подачу делает сам клиент через Госуслуги — это требование закона. 10 лет в регуляторике грузоперевозок Москвы.
              </p>
            ...
            <div className="relative rounded-3xl border border-primary-foreground/15 bg-primary-foreground/[0.06] p-6 backdrop-blur sm:p-8">
              ...
              <div className="mt-6 rounded-2xl bg-primary-foreground/10 p-4 text-xs text-primary-foreground/80">
                ...
                регистрация бесплатная. Мы помогаем подготовиться и сопровождаем на каждом этапе — но обязательную подачу делает сам клиент.
              </div>
            </div>
          </div>
        </div>
