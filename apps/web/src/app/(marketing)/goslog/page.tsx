...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Регистрация в реестре ГосЛог под ключ — Инфолог24",
    description:
...
const steps = [
  {
    ...
    description:
      "Проверяем пакет документов вашей компании на соответствие требованиям реестра",
  },
  {
    icon: FileText,
            ...
            <Card className="rounded-2xl border-destructive/20 bg-destructive/5 shadow-sm">
              <CardContent className="p-6 sm:p-8 text-center">
                ...
                <p className="mt-2 text-sm text-muted-foreground">
                  штраф за работу без регистрации в ГосЛог (первое нарушение)
                </p>
              </CardContent>
            </Card>
            <Card className="rounded-2xl border-destructive/20 bg-destructive/5 shadow-sm">
