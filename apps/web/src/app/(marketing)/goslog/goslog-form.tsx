          ...
          <div className="flex items-start gap-3 rounded-2xl border border-accent/40 bg-accent/10 p-4 text-sm text-primary-foreground">
            ...
            <div>
              ...
              <p className="mt-1 text-primary-foreground/80">
                Мы сосредоточены на перевозчиках к 1 марта 2027. Экспедиторов быстрее регистрируют наши партнёры — Контур или аудит-бюро «Картель». Оставьте заявку — свяжемся, расскажем вариант и дадим контакт партнёра.
              </p>
            </div>
          </div>
        )}
