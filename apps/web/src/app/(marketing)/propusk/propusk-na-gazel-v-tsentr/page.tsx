...
export const metadata: Metadata = {
  ...
  description:
    "Помощь в оформлении пропуска на Газель в Москву. Какие Газели требуют пропуск, документы, сроки, штрафы. Сопровождаем оформление пропуска на МКАД, ТТК и Садовое кольцо.",
  keywords: [
    "пропуск на газель",
...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "Стоимость одинакова для всех зон: годовой пропуск на МКАД, ТТК или Садовое кольцо — 12 000 ₽ за машину. Временный пропуск в любую зону на срок до 10 суток — 4 500 ₽.",
  },
  {
  ...
  return (
    <>
      <ServiceJsonLd
        ...
        description="Помощь в оформлении пропуска на Газель для проезда по МКАД, ТТК и Садовому кольцу"
        price={4500}
        url={absoluteUrl("/propusk/propusk-na-gazel-v-tsentr")}
      />
