...
export const metadata: Metadata = {
  title: "Пропуска для ТК от 5 машин — Инфолог24",
  description:
    "Помощь в оформлении пропусков на МКАД, ТТК и Садовое кольцо для транспортных компаний с парком 5–20 грузовиков. Персональный менеджер, мониторинг сроков, скидка от 5 ТС. Гарантия результата.",
  keywords: [
...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "Да, помогаем с оформлением пропусков на лизинговые и арендованные ТС. Потребуется дополнительно договор лизинга или аренды. Менеджер подскажет точный список документов.",
  },
];
...
export default function MalyeTkPage() {
  return (
    <>
      ...
      />
      <ServiceJsonLd
        name="Помощь с оформлением пропусков для транспортных компаний (5–20 ТС)"
