...
export const metadata: Metadata = {
  title: "Переход на ЭТрН под ключ — от 25 000 ₽ · Инфолог24",
  description:
...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "От 3 до 7 рабочих дней в стандартном режиме. Основное время уходит на получение УКЭП (1-3 дня) и подключение к оператору ЭДО (1-2 дня). Мы параллелим процессы, чтобы сэкономить время.",
  },
  {
  ...
  return (
    <>
      <ServiceJsonLd
        ...
        description="Помощь с переходом на ЭТрН: получение УКЭП, подключение к ЭДО, обучение. Под ключ, от 25 000 руб."
        price={25000}
        url="/etrn"
      />
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <ul className="mt-4 space-y-3">
                  ...
                  <li className="flex items-start gap-2 text-sm text-muted-foreground">
                    <span className="mt-1.5 size-1.5 shrink-0 rounded-full bg-destructive" />
                    Ближе к дедлайну очереди на получение УКЭП и подключение к ЭДО
                    растут
                  </li>
                  <li className="flex items-start gap-2 text-sm text-muted-foreground">
                    <span className="mt-1.5 size-1.5 shrink-0 rounded-full bg-destructive" />
