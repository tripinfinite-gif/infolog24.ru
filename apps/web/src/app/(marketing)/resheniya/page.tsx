...
const hubFaq = [
  ...
  },
  {
    ...
    answer:
      "Базовое подключение — 1 рабочий день после получения документов. Помощь с оформлением пропуска — регламент Дептранса Москвы до 10 рабочих дней (временный пропуск выдаём сразу). Подключение РНИС, ЭТрН, ГосЛог — в составе пакета, без переплат.",
  },
  {
