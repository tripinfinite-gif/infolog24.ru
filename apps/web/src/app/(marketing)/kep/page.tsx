...
export const metadata: Metadata = {
  title:
    "КЭП и МЧД для перевозчика — помощь в оформлении от 5 000 ₽ за 1–3 дня | Инфолог24",
  description:
    "Квалифицированная электронная подпись (КЭП/УКЭП) и машиночитаемая доверенность (МЧД) для перевозчиков. Нужна для ЭТрН, ГосЛог, Госуслуг бизнеса. Помогаем получить через УЦ ФНС и аккредитованные УЦ (Контур, СБИС, Такском) за 1–3 дня.",
  keywords: [
    "КЭП для перевозчика",
    "УКЭП грузоперевозки",
  ...
  openGraph: {
    ...
    description:
      "Помогаем получить электронную подпись и МЧД через УЦ ФНС и аккредитованные центры. Нужно для ЭТрН, ГосЛог, mos.ru. От 5 000 ₽, 1–3 дня.",
    type: "website",
    url: absoluteUrl("/kep"),
    siteName: "Инфолог24",
  },
  twitter: {
    ...
    title: "КЭП и МЧД для перевозчика — Инфолог24",
    description: "Помощь с электронной подписью, 1–3 дня. От 5 000 ₽.",
  },
  alternates: {
...
const packages = [
  {
    ...
    features: [
      "Сопровождение получения УКЭП в УЦ ФНС или аккредитованном УЦ",
  ...
  },
  {
    ...
    features: [
      ...
      "Помощь в оформлении МЧД на 1–3 сотрудников",
...
const steps = [
  ...
  {
    icon: KeyRound,
    title: "Получение КЭП через УЦ",
    description:
      "УЦ-партнёр (Контур, СБИС, Такском или ФНС) формирует сертификат. Мы сопровождаем процесс, ключ записывается на защищённый носитель.",
    time: "1–2 дня",
  },
  {
    icon: Fingerprint,
...
const faq = [
  ...
  },
  {
    ...
    answer:
      "Можно, но есть нюансы: нужно иметь носитель с сертификатом ФСБ (сам Рутокен — 1 500 ₽), лично приехать в ФНС, потратить день в очередях, самостоятельно настроить ПО (КриптоПро, драйверы, плагин). Мы помогаем пройти весь процесс за 1–3 дня через партнёрский УЦ (Контур, СБИС, Такском) — подготовка документов, запись, сопровождение в инспекции. Стоимость услуг сопровождения — от 5 000 ₽. Плюс — наша КЭП совместима с ЭТрН всех операторов сразу.",
  },
  {
  ...
  return (
    <>
      <ServiceJsonLd
        ...
        description="Помощь в получении квалифицированной электронной подписи (УКЭП) и машиночитаемой доверенности (МЧД) через УЦ ФНС и аккредитованные УЦ. Нужно для ЭТрН, ГосЛог, mos.ru."
        price={5000}
        url="/kep"
      />
      <FaqJsonLd items={faq} />
      ...
      <section className="px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <h1 className="font-heading text-3xl font-bold leading-tight text-foreground sm:text-4xl lg:text-5xl">
            КЭП и МЧД — помощь в оформлении за 1–3 дня
          </h1>
          <p className="mx-auto mt-6 max-w-2xl text-lg leading-relaxed text-muted-foreground">
            Сопровождаем получение квалифицированной подписи (УКЭП) и
            машиночитаемой доверенности через УЦ ФНС и аккредитованные
            удостоверяющие центры (Контур, СБИС, Такском). Без ваших походов
            в ФНС, без настройки КриптоПро. Ключ сразу готов для ЭТрН, ГосЛог,
            mos.ru и Госуслуг.
          </p>
