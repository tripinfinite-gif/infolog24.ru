...
const textSnippets = [
  {
    id: "1",
    title: "Для Telegram / WhatsApp",
    text: `Оформляете пропуск в Москву? Сервис Инфологистик-24 оформит пропуск на МКАД, ТТК или Садовое кольцо за вас — быстро и с гарантией. Работают с 2016 года.\n\nОставьте заявку: ${BASE_URL}/?ref=${PARTNER_CODE}`,
  },
  {
    id: "2",
    title: "Для email-рассылки",
    text: `Уважаемые коллеги!\n\nРекомендуем проверенный сервис по оформлению пропусков в Москву — Инфологистик-24. Компания берёт на себя всю работу: от подготовки документов до подачи заявки. Оформление от 3 дней.\n\nПодробности: ${BASE_URL}/?ref=${PARTNER_CODE}`,
  },
  {
    id: "3",
    title: "Короткий пост для соцсетей",
    text: `Пропуск в Москву для грузового транспорта — без очередей и отказов. Сервис Инфологистик-24: быстро, надёжно, с гарантией.\n\n${BASE_URL}/?ref=${PARTNER_CODE}`,
  },
];
...
const UTM_LINKS = [
  {
    label: "Telegram",
    url: `${BASE_URL}/?ref=${PARTNER_CODE}&utm_source=telegram&utm_medium=message&utm_campaign=partner`,
  },
  {
    label: "Email",
