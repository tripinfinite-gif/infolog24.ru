...
> **Claude Code, важно:** в проекте установлен **RooFlow** (мультиагентный инструмент для расширения Roo Code в VS Code). Файлы `.roo/`, `.roomodes`, `generate_mcp_yaml.py`, `install_rooflow.sh`, `memory-bank/` относятся к нему, **никогда не читай их** и не включай в анализ — это сэкономит токены. Они в `.gitignore`. RooFlow и Claude Code работают параллельно и независимо.
